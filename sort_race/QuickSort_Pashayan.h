...
int Separation(vector<T>& mass, int low, int high) { 
    ...
    // дл€ улучшени€ эффективности в качестве опорного элемента выбираетс€ медиана первого, среднего и последнего элементов
    int mid;    
    mid = (low + high) / 2;
    ...
    // –азбиение Ћомуто(low и high Ч соответственно, нижн€€ и верхн€€ границы сортируемого массива)
